...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Character/AI/Actions/AIActionAttackTargetWRotation")]
	//[RequireComponent(typeof(CharacterOrientation3D))]
	//[RequireComponent(typeof(CharacterHandleWeapon))]
	public class AIActionAttackTargetWRotation : AIAction
	{
		...
		public AICharacterHandleWeapon TargetHandleWeaponAbility;
		...
		public override void Initialization()
		{
			...
			{
				TargetHandleWeaponAbility = _character?.FindAbility<AICharacterHandleWeapon>();
			}
		}
		...
		{
			// move character in orbit around target
			Debug.Log("RotateAroundTarget");
			Vector3 targetPosition = _brain.Target.position;
			Vector3 _direction = targetPosition - _character.transform.position;
		...
		protected virtual void Shoot()
		{
			...
			{
				Debug.LogWarning("TARGET WEAPON IS NULL");
				OnEnterState();
			}
		}
